...
export const CONFLICT_ZONES: ConflictZone[] = [
  {
    ...
    casualties: '1,500+ civilians, 5,000+ military, 13 U.S. personnel killed',
    ...
    keyDevelopments: ['Khamenei killed in Tehran strikes', '1000+ Iranian targets struck', '13 U.S. service members killed and 300+ wounded', 'Iranian missile/drone retaliation on Gulf states'],
    costTracking: {
      strikeStart: '2026-02-28T04:00:00Z',
      firstPhaseCostUsd: 11_300_000_000,
      firstPhaseDays: 6,
      ongoingDailyCostUsd: 1_000_000_000,
      sourceLabel: 'Iran War Cost Tracker citing Pentagon briefing to Congress',
      sourceUrl: 'https://iran-cost-ticker.com/',
      note: 'Tracker model uses the Pentagon\'s reported $11.3B cost for the first six days of strikes, then adds $1B for each additional day the operation continues. The site notes this is likely a conservative estimate.',
      lastUpdated: '2026-04-03',
    },
    casualtyBreakdown: {
      usServiceMembersKilled: 13,
      usServiceMembersWounded: '300+',
      militaryKilled: '5,007+',
      civilianKilled: '1,508+',
      civilianWounded: '21,079+',
      note: 'Tracker casualty totals are incident-based and roll forward cumulative reports to avoid double counting.',
      sourceSummary: 'Sources: DoD/CENTCOM, Iranian Red Crescent, Hengaw, AP, Reuters, Al Jazeera',
      lastUpdated: '2026-04-03',
    },
  },
  {
